...
urlpatterns = [ 
    ...
    # class based views
    path('api/home', EmployeeAPIView.as_view(), name='employee_list_api_view'),
    path('api/home_detail/<int:id>', EmployeeDetailsAPIView.as_view(), name='employee_detail_api_view'),
